...
public class GeneratorProperties {
	...
	static String PROPERTIES_FILE_NAMES[] = new String[]{"generator.properties","generator.xml"};
	...
	public static void reload() {
		try {
			helper = new PropertyPlaceholderHelper("${", "}", ":", false);
			PROPERTIES_FILE_NAMES = new String[]{"generator.properties","generator.xml"};
			props = new PropertiesHelper(new Properties(),true);
